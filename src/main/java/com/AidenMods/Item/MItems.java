...
public class MItems {
	...
	public static void initilizeItem(){
		...
		oBlock = new Item().setUnlocalizedName("oBlock").setCreativeTab(MCreativeTabs.tabItems).setTextureName(RefStrings.MODID + ":oBlock");
	...
	public static void registerItem(){
		...
		GameRegistry.registerItem(oBlock, oBlock.getUnlocalizedName());
