...
public class ChewOre implements IWorldGenerator {
	...
	private void generateOverworld(Random random, int chunkX, int chunkZ, World world) {
		addOre(MBlocks.ComStone, Blocks.stone, random, world, chunkX, chunkZ, 5, 20, 10, 20, 20);
		addOre(MBlocks.WormStone, Blocks.stone, random, world, chunkX, chunkZ, 100, 200, 10, 20, 20);
